...
## 简介 Introduction   
DUIX全称为"Dialogue User Interface System"，是硅基智能打造的数字人智能交互平台，已进行开源，开发者能够在Android和iOS等设备上一键部署，为用户提供即时的虚拟人互动体验。内置的两个形象使得用户可以轻松上手，直接体验数字人的魅力。
本项目提供了直观的效果展示，还支持用户进行二次开发。可以根据提供的开放文档轻松开发出定制化的虚拟人应用，底层推理引擎以及上层的商业化应用逻辑都开放了源代码。开发者可以深入了解其工作原理，并进行进一步的优化和创新。  <br><br> 
